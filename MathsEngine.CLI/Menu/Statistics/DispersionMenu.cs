    ...
    public class DispersionMenu
    {
        ...
        private static void HandleArrayOfNumbers()
        {
            try
            {
                ...
                calculator.Run();
                DispersionDisplayHelper.DisplayArrayOfNumbersData(calculator);
        ...
        private static void HandleFrequencyTable()
        {
            try
            {
                ...
                calculator.Run();
                DispersionDisplayHelper.DisplayFrequencyTableData(calculator);
        ...
        private static void HandleContinuousTable()
        {
            try
            {
                ...
                calculator.Run();
                DispersionDisplayHelper.DisplayContinuousTableData(calculator);
