...
namespace MathsEngine.WinForms.Views.Statistics.Bivariate_Analysis
{
    partial class BivariateAnalysisCalculatorView
    {
        ...
        private void InitializeComponent()
        {
            ...
            GraphPlot = new ScottPlot.WinForms.FormsPlot();
            ResetGraphButton = new Button();
            LineEquationLabel = new Label();
            ...
            // StepsTextBox
            // 
            StepsTextBox.Location = new Point(570, 30);
            StepsTextBox.Name = "StepsTextBox";
            StepsTextBox.ReadOnly = true;
            StepsTextBox.Size = new Size(448, 301);
            ...
            _containerPanel.Location = new Point(19, 85);
            ...
            _calculateButton.Location = new Point(294, 392);
            ...
            _clearButton.Location = new Point(19, 392);
            ...
            // GraphPlot
            // 
            GraphPlot.Anchor = AnchorStyles.Right;
            GraphPlot.Location = new Point(550, 354);
            GraphPlot.MaximumSize = new Size(591, 303);
            GraphPlot.Name = "GraphPlot";
            GraphPlot.Size = new Size(591, 303);
            GraphPlot.TabIndex = 10;
            // 
            // ResetGraphButton
            // 
            ResetGraphButton.Location = new Point(417, 470);
            ResetGraphButton.Name = "ResetGraphButton";
            ResetGraphButton.Size = new Size(125, 60);
            ResetGraphButton.TabIndex = 11;
            ...
            // LineEquationLabel
            // 
            LineEquationLabel.AutoSize = true;
            LineEquationLabel.Location = new Point(294, 558);
            LineEquationLabel.Name = "LineEquationLabel";
            LineEquationLabel.Size = new Size(90, 15);
            LineEquationLabel.TabIndex = 12;
            ...
            Controls.Add(LineEquationLabel);
            Controls.Add(ResetGraphButton);
            Controls.Add(GraphPlot);
            ...
            Controls.SetChildIndex(GraphPlot, 0);
            Controls.SetChildIndex(ResetGraphButton, 0);
            Controls.SetChildIndex(LineEquationLabel, 0);
        ...
        private Label LineEquationLabel;
    }
}