...
namespace MathsEngine.Modules.Statistics.Dispersion
{
    public class ArrayOfNumbersCalculator : IStandardDeviation
    {
        ...
        public (List<double> OriginalValues, List<double> SortedValues, double Median, List<double> ModeList, double Range, double Q1, double Q3, double IQR) GetStatistics()
        {
            return (_originalValues, _sortedValues, _median, _modeList, _range, _q1, _q3, _iqr);
        }
    }
}